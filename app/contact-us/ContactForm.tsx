  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        style={{ ...inputBase, borderColor: focused ? "#146EFF" : "rgba(255,255,255,0.10)" }}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ...
        onFocus={() => setFocused(true)}
        onBlur={() => setFocused(false)}
        style={{ ...textareaBase, borderColor: focused ? "#146EFF" : "rgba(255,255,255,0.10)" }}
      />
    </div>
  );
}
...
export function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center gap-4 py-8 text-center">
        ...
        >
          <CheckCircle2 size={28} style={{ color: "#7ab8ff" }} strokeWidth={1.75} />
        </div>
        <div>
          <p className="text-white font-semibold text-lg mb-1" style={{ fontFamily: "var(--font-bricolage)" }}>
            message sent!
          </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      <Field label="Name" name="name" placeholder="Your full name" value={form.name} onChange={handleChange} required />
      <Field label="Email" name="email" type="email" placeholder="you@company.com" value={form.email} onChange={handleChange} required />
      <Field label="Subject" name="subject" placeholder="How can we help?" value={form.subject} onChange={handleChange} required />
      <TextareaField label="Message" name="message" placeholder="Tell us more about your requirement…" value={form.message} onChange={handleChange} required />
